...
// SQL query to fetch only Thriller & Suspense category books from database
$query = "SELECT * FROM books WHERE category='Thriller & Suspense'"; // Change category to "Thriller & Suspense" for thrillersuspense.php
...
<head>
  ...
  <title>Books - Thriller & Suspense</title>
</head>
...
<body>
  ...
  <div class="container">
    <!-- Page heading specific to Thriller & Suspense category -->
    <h1 class="title">Thriller & Suspense</h1>
    <!-- Subheading description for Thriller & Suspense category -->
    <p class="subtitle">Explore our Thriller & Suspense books collection</p>
    ...
    <div class="categories">
      ...
      <button class="active">Thriller & Suspense</button>
    </div>
